...
public class ContextCapturer extends BaseContextHandler {
    ...
    public String transformToRegex(String pattern) {
        return pattern.replaceAll(GROUP_PATTERN, GROUP_PATTERN_REGEX);
    }

    public void captureValuesFromPattern(String regexPattern, List<String> groups, String value) {
    ...
    public boolean doesNotMatchPattern(String value, String regexPattern) {
